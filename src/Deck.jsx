    ...
    <div className="min-h-screen w-full bg-[#f2efe8]" style={{fontFamily:'Plus Jakarta Sans'}}>
      ...
      {selected && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4" onClick={()=>setSelected(null)}>
          <div className="bg-white rounded-[10px] w-full max-w-[340px] p-6" onClick={e=>e.stopPropagation()}>
            ...
            {selected.photo_url? <img src={selected.photo_url} className="w-24 h-24 rounded-[8px] object-cover mx-auto" alt="" /> : <div className="w-24 h-24 rounded-[8px] bg-[#c9ad83] text-white flex items-center justify-center text-[28px] font-extrabold mx-auto">{(selected.display_name?.[0]||'?').toUpperCase()}</div>}
